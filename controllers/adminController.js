...
export const withdraw = async (req, res) => {
  ...
  if (checkEmail(email)) {
    ...
    if (user) {
      ...
      // sendMailx(msg, 'support@rhodeanalytics.com', 'Withdrawal Requested');
...
export const approveDeposit = async (req, res) => {
  ...
  try {
    ...
    let msg = `Your Deposit of ${deposit}USD has been approved.
      \nThank you for choosing rhodeanalytics. For complaints or inquires, do not hesitate to contact our 24/7 support team via email: support@rhodeanalytics .com\n
